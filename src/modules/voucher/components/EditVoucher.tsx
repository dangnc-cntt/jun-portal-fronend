...
class EditVoucher extends Component {
    ...
    render() {
        return (
            <div className="modal fade" id="editVoucher" tabIndex={-1} role="dialog" aria-hidden="true">
                <div className="modal-dialog w-100 h-100 d-flex align-items-center justify-content-center m-0"
                    ...
                    <div className="modal-content" style={{maxWidth: 1200}}>
                                ...
                                <div className="col-6">
                                    ...
                                    <div className="form-group">
                                        ...
                                        <select className="form-control" value={voucherStore.dataRequest.type}
                                            ...
                                            <option value="PERCENT" selected={voucherStore.dataRequest.type === "PERCENT"}>PERCENT</option>
                                            <option value="MINUS" selected={voucherStore.dataRequest.type === "MINUS"}>MINUS</option>
                                        </select>
                                    </div>
                                    <div className="form-group">
                                        <label>State</label>
                                        <select className="form-control" value={voucherStore.dataRequest.state}
                                            ...
                                            <option value="">Choose</option>
                                            <option value="ACTIVE" selected={voucherStore.dataRequest.type === "ACTIVE"}>ACTIVE</option>
                                            <option value="INACTIVE" selected={voucherStore.dataRequest.type === "INACTIVE"}>INACTIVE</option>
                                        </select>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div className="modal-footer border-top-0 pt-0">
                            ...
                            <button type="button" onClick={() => voucherStore.edit()}
