...
class AddBrand extends Component {
    ...
    render() {
        return (
            <div className="modal fade" id="addBrand" tabIndex={-1} role="dialog" aria-hidden="true">
                <div className="modal-dialog w-100 h-100 d-flex align-items-center justify-content-center m-0" role="document">
                    <div className="modal-content">
                        ...
                        <div className="modal-footer border-top-0 pt-0">
                            ...
                            <button type="button" onClick={() => brandStore.addBrand()} className="btn btn-info">Create</button>
                        </div>
                    </div>
                </div>
            </div>
