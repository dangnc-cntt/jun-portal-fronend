...
import {getLocalDateTime, goBack, number_format} from "../../../../common/utils/Utils";
...
@observer
class DetailReceipt extends Component<IProps, any> {

   async componentDidMount() {
       await receiptStore.detailReceipt(this.props.match.params.id)
   }

    render() {
       if(receiptStore.receiptDetail){
           return (
               <div className="detail_receipt">
                   <div className="content-wrapper">
                       <div className=" d-flex align-items-center justify-content-between mt-2 mb-3">
                           <div className="pl-2 pr-2 w-100 d-flex align-items-center">
                               ...
                               <h3 className="mb-0">Detail Receipt</h3>
                           </div>
                       </div>
                       <div className="card">
                           <div className="card-body">
                               <div className="form-group mb-4">
                                   ...
                                   <p>{receiptStore.receiptDetail.description}</p>
                               </div>
                               <div className="form-group h-auto mb-4">
                                   <label>Products</label>
                                   <div className="table-responsive ">
                                       {receiptStore.receiptDetail.products && receiptStore.receiptDetail.products.length > 0 ?
