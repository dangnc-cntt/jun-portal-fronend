        ...
        uploadTask.on(
            ...
            () => {
                storage
                    ...
                    .getDownloadURL()
                    .then(url => {
                        configStore.dataRequest.value.push(url);
                    });
            }
        )
    }
                ...
                <div className="modal-dialog w-100 h-100 d-flex align-items-center justify-content-center m-0" role="document">
                    <div className="modal-content">
                        <div className="modal-header">
                            <h3 className="mb-0">Add Config</h3>
                        ...
                        <div className="modal-body">
                            <div className="form-group">
                                ...
                                <input type="text"
                                       ...
                                       value={configStore.dataRequest.key}
                                       onChange={(e: any) => configStore.dataRequest.key = e.currentTarget.value}
                                />
                            </div>
                            <div className="form-group">
                                <label>Type</label>
                                <select value={configStore.dataRequest.type} onChange={(e: any) => configStore.dataRequest.type = e.currentTarget.value} className="form-control">
                            ...
                            <div className="form-group">
                                ...
                                <div className="d-flex">
                                    {configStore.dataRequest.value && configStore.dataRequest.value.map((value: any, i: number) => {
                                        return <div className="position-relative mr-2">
                                            <img style={{width: 80, height: 40}} className="mr-2 ml-2"
                                                 src={value} key={i} alt=""/>
                                            <i className="fal fa-times" css={i} onClick={() => configStore.dataRequest.value.splice(i, 1)}/>
                                        </div>
                                    })}
                                </div>
                        ...
                        <div className="modal-footer border-top-0 pt-0">
                            ...
                            <button type="button" onClick={() => configStore.addConfig()} className="btn btn-info">Create</button>
                        </div>
                    </div>
                </div>
            </div>
